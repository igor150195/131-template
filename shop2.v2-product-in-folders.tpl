{if $product.folders && $shop2.my.show_sections}
    ...
    {capture assign="product_folders"}{strip}
        {foreach from=$product.folders item=e key=k name=foo}
            {if $e._level}
                <a href="{get_seo_url uri_prefix=$shop2.uri mode="folder" alias=$e.alias}" class="{$shop2.my.gr_folders_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-folders__item">
                    <span>
                        {$e.folder_name}
                        <i>
