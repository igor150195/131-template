                        ...
                        <div class="product-additional__top-right">
                        	<div class="product-item-btns">
                        		{if $shop2.my.gr_info_form}
		                            ...
		                            {if $product.buy_mode==1}
				                		<div class="buy-one-click product_info_form {$shop2.my.buy_one_click_action_class|default:'gr-btn gr-btn-1'}{if $site.product_settings.mode_catalog || $smarty.get.gr_mode_catalog == '1'} buy_one_click_action{/if}" 	
                    	...
                    	{if !$hide_gr_thumbs_one_click}
	                    	{if $shop2.my.gr_info_form}
	                    		{if $shop2.my.gr_thumbs_one_click && $product.buy_mode!=1}
		                            <div class="buy-one-click {if $site.product_settings.mode_catalog || $smarty.get.gr_mode_catalog == '1'} buy_one_click_action {$shop2.my.buy_one_click_action_class|default:'gr-btn gr-btn-1'}{else} {$shop2.my.buy_one_click_class|default:'gr-btn gr-btn-3'}{/if}"
		                            	data-remodal-target="buy-one-click"
		                            	data-product-link="{$smarty.server.PROTOCOL}://{$smarty.server.HTTP_HOST}{get_seo_url uri_prefix=$shop2.uri mode="product" alias=$product.alias}" 
			                        	data-product-name="{$product.name}"
