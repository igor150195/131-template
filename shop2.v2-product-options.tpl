							...
							<div class="option-item__inner">
								...
								{elseif $option.type == 'file2'}
									...
									{if $filename}
										...
										<div class="option-title">{$option.name}</div>
										<div class="option-body">
											<a href="{$FILES_DIR}{$filename}" class="{$shop2.my.gr_file|default:'gr-btn gr-btn-3 gr-btn-sm gr_btn_i_r'} file">
												<span>
													{#SHOP2_DOWNLOAD#}
													<i>
		...
		<div class="gr-product-options">
	        ...
	        {if $shop2.my.gr_product_options_more_btn!="" && $mode=='product'}
				<div class="gr-product-options-more">
					<div class="{$shop2.my.gr_params_more_btn_class|default:'product-more-btn'} gr-product-options-more__btn" data-text="{$shop2.my.gr_product_options_more_btn}">
			            <span>
			            	<ins>
