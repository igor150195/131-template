	...
	<div class="card-page">
	    <div class="card-page__top">
	        ...
	        {if $shop2.next_prev_link && !$shop2.fallback_mode}
	            <div class="card-nav">
	            <!--noindex-->
	                <a rel="nofollow" class="{$shop2.my.card_nav_left_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_l'} card-nav__btn" href="{get_seo_url uri_prefix=$shop2.uri uri_postfix="prev" mode="product" alias=$product.alias}">
	                    <span>
	            ...
	            <!--/noindex-->
	            <!--noindex-->
	                <a rel="nofollow" class="{$shop2.my.card_nav_right_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} card-nav__btn" href="{get_seo_url uri_prefix=$shop2.uri uri_postfix="next" mode="product" alias=$product.alias}">
	                    <span>
	                                	...
	                                	{if $shop2.my.gr_info_form}
				                            {if $product.buy_mode==1}
					                            {if !empty($product_info_form.my_form.dictionaries)}
					                                <div class="buy-one-click product_info_form {$shop2.my.product_buy_one_click_action_class|default:'gr-btn gr-btn-lg gr-btn-1'}{if $site.product_settings.mode_catalog} buy_one_click_action{/if}" 
	                            ...
	                            {if $shop2.my.gr_info_form}
	                            	{if $product.buy_mode!=1}
	                            		{if !empty($one_click_form.my_form.dictionaries)}
			                                <div class="buy-one-click {if $site.product_settings.mode_catalog} buy_one_click_action {$shop2.my.product_buy_one_click_action_class|default:'gr-btn gr-btn-lg gr-btn-1'}{else} {$shop2.my.product_buy_one_click_class|default:'gr-btn gr-btn-lg gr-btn-3'}{/if}" 
			                                	data-remodal-target="buy-one-click"
			                                	data-product-link="{$smarty.server.PROTOCOL}://{$smarty.server.HTTP_HOST}{get_seo_url uri_prefix=$shop2.uri mode="product" alias=$product.alias}" 
					                        	data-product-name="{$h1|default:$page.h1|default:$page.name}"
	            ...
	            <div class="shop-product-tags">
	                ...
	                <div class="shop-product-tags__items">
	                    {foreach from=$tags_full item=e key=k name=foo}
	                        <a href="/{$e.url}" class="{$shop2.my.gr_tag_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-tags__item">
	                            <span>
