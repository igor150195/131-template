							...
							<div class="shop2-filter__body">
                                ...
                                {if $count>$gr_max_count}
									...
									<div class="gr-filter-more">
										<span class="{$shop2.my.gr_filter_more_btn_class|default:'gr-btn gr-btn-sm gr-btn-3'} gr-filter-more__btn" data-text="{$shop2.my.gr_filter_select_btn|default:'Показать еще'}" data-fields-total="{$selects_total}"><span class="gr-filter-more__text">{$shop2.my.gr_filter_select_btn|default:'Показать еще'}</span><span class="gr-filter-more__amount"> {$selects_total}</span></span>
									</div>
								{/if}
							</div>
						</div>
