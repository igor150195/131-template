                ...
                if ($('#product-tabs').length) {
                    $('.shop-product-data__nav li, .r-tabs-accordion-title').on('click', function(e){
                        ...
                        if (window.matchMedia("(min-width: 768px)").matches) {
                            $('#product-tabs a[href="'+ href +'"]').addClass('active').parent().addClass('r-tabs-state-active');
                            $descArea.stop().slideDown(300);
                        } else {
                            $('#product-tabs a[href="'+ href +'"]').toggleClass('active').parent().toggleClass('r-tabs-state-active');
