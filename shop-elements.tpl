            ...
            <div class="user-block">
                ...
                <div class="user-block__btns">
                    <div class="user-block__orders">
                        <a href="orders" class="gr-btn gr-btn-1 user-orders-btn">
                            Мои заказы
                        </a>
                    </div>
                    <div class="user-block__logout">
                        <a href="logout" class="gr-btn gr-btn-3 user-logout-btn">
                            Выйти
                        </a>
                    </div>
                </div>
        ...
        <form action="#" class="shop2-filter">
            ...
            <div class="shop2-filter__add">
                <div class="shop2-filter-btns">
                    <a href="#" class="{$shop2.my.gr_filter_go_class|default:'gr-btn gr-btn-lg gr-btn-1'} shop2-filter-go">
                    ...
                    <a href="{$SCRIPT_NAME}" class="{$shop2.my.gr_filter_reset_class|default:'gr-btn gr-btn-lg gr-btn-3 gr_btn_i_r'} shop2-filter-reset">
                        <span>
		...
		<form method="post" class="tpl-form">
			...
			<div class="tpl-field tpl-field-reg">
                <div class="comments-chekbox">
                    ...
                    <span>Я согласен(на) на обработку моих персональных данных. <a href="http://gr-shop2-2-130.oml.ru/registraciya/agreement" target="_blank">Подробнее</a></span>
                </div>
            </div>

			<div class="tpl-field-button">
                <button class="{$shop2.my.comments_form_btn_class|default:'gr-btn gr-btn-1'}" type="submit">
                    {#SHOP2_SEND2#}
                </button>
            </div>
...
<div class="card-page">
    <div class="shop-product-tags">
        ...
        <div class="shop-product-tags__items">
            <a href="/" class="{$shop2.my.gr_tag_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-tags__item">
                <span>
                    Тег номер 1
                    <svg class="gr-svg-icon">
    ...
    <div class="card-page">
    	<div class="shop-product-folders">
            ...
            <div class="shop-product-folders__items">
                <a href="/shopfoldershop/folder/kategoriya-tovarov-1" class="{$shop2.my.gr_folders_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-folders__item">
                    <span>
                        Категория товаров 1
                        <svg class="gr-svg-icon">
                            <use xlink:href="#icon_shop_tag_arr"></use>
                ...
                <a href="/shopfoldershop/folder/kategoriya-tovarov-3" class="{$shop2.my.gr_folders_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-folders__item">
                    <span>
                        Категория товаров 3
                        <svg class="gr-svg-icon">
                            <use xlink:href="#icon_shop_tag_arr"></use>
                ...
                <a href="/shopfoldershop/folder/gruppa-tovarov-b" class="{$shop2.my.gr_folders_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-folders__item">
                    <span>
                        Группа товаров Б
                        <svg class="gr-svg-icon">
                            <use xlink:href="#icon_shop_tag_arr"></use>
                ...
                <a href="/shopfoldershop/folder/gruppa-tovarov-v" class="{$shop2.my.gr_folders_item_class|default:'gr-btn gr-btn-sm gr-btn-3 gr_btn_i_r'} shop-product-folders__item">
                    <span>
                        Группа товаров В
                        <svg class="gr-svg-icon">
                            <use xlink:href="#icon_shop_tag_arr"></use>
            ...
            <div class="shop2-product-options">
                ...
                <div class="option-item even" data-option-type="file2">
                    <div class="option-item__inner">
                        ...
                        <div class="option-body">
                            <a href="/d/442666/d/document_1.docx" class="{$shop2.my.gr_file|default:'gr-btn gr-btn-3 gr-btn-sm gr_btn_i_r'} file">
                                <span>
                                    Скачать
                                    <svg class="gr-svg-icon">
