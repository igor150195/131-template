                            ...
                            {else}
                                ...
                                {if $folder.vendors|@count>$gr_max_count}
                                    ...
                                    <div class="gr-filter-more">
                                        <span class="{$shop2.my.gr_filter_more_btn_class|default:'gr-btn gr-btn-sm gr-btn-3'} gr-filter-more__btn" data-text="{$shop2.my.gr_filter_select_btn|default:'Показать еще'}" data-fields-total="{$vendors_total}"><span class="gr-filter-more__text">{$shop2.my.gr_filter_select_btn|default:'Показать еще'}</span><span class="gr-filter-more__amount"> {$vendors_total}</span></span>
                                    </div>
                                {/if}
                            {/if}
                ...
                <div class="sorting-panel">
                    <div class="sorting-panel__body">
                        {if $shop2.my.gr_filter_remodal_btn!=""}
	                        ...
	                        {/if}
                                <div class="{$shop2.my.filter_popup_btn_class|default:'gr-btn gr-btn-lg gr-btn-1 gr_btn_i_r'} filter-popup-btn" data-remodal-target="filter-popup">
                                    <span>
