			...
			{if isset($user.user_id)}
				...
				<div class="user-block">
					...
					<div class="user-block__settings">
						<a href="{$user_settings.link}?mode=user" class="{$shop2.my.user_settings_btn_class} user-settings-btn">
					...
					<div class="user-block__btns">
						<div class="user-block__orders">
							<a href="{get_seo_url mode=orders uri_prefix=$shop2.uri}" class="{$shop2.my.user_orders_btn_class|default:'gr-btn gr-btn-1'} user-orders-btn">
								{$shop2.my.gr_login_form_orders|default:#SHOP2_MY_ORDERS#}
							</a>
						</div>
						<div class="user-block__logout">
							<a href="{get_seo_url mode=logout uri_prefix=$user_settings.link}" class="{$shop2.my.user_logout_btn_class|default:'gr-btn gr-btn-3'} user-logout-btn">
				...
				<form method="post"{if $user_settings.link} action="{$user_settings.link}"{/if}>
					...
					<div class="login-form__btns">
						<div class="login-form__enter">
							<button type="submit" class="{$shop2.my.user_enter_btn_class|default:'gr-btn gr-btn-1'} user-enter-btn" tabindex="3">{#SHOP2_LOG_IN#}</button>
						</div>
						{if $shop2.my.gr_login_form_wrap_links}
							<div class="login-form__links">
						{/if}
							<div class="login-form__forgot">
								<a href="{get_seo_url mode=forgot_password uri_prefix=$user_settings.link}" class="{$shop2.my.user_forgot_btn_class} user-forgot-btn">
									{#SHOP2_FORGOT_PASSWORD#}
								</a>
							</div>
							<div class="login-form__reg">
								<a href="{get_seo_url mode=register uri_prefix=$user_settings.link}" class="{$shop2.my.user_reg_btn_class|default:'gr-btn gr-btn-3'} user-reg-btn">
									{#SHOP2_REGISTRATION#}
								</a>
							</div>
						{if $shop2.my.gr_login_form_wrap_links}
