	...
	{if $smarty.get.products_only}
		...
		<div class="cart-popup">
			...
			<div class="cart-popup__top">
				<form action="{$shop2.uri}?mode=cart&action=up" id="shop2-cart" autocomplete="off">
				...
				<div class="cart-update hide">
					<a href="javascript:void(0);" class="{$shop2.my.cart_update_btn_class|default:'gr-btn gr-btn-lg gr-btn-3'} cart-update__btn shop2-cart-update">
		...
		<div class="cart-page">
			<div class="cart-page__top">
				<div class="cart-page__left">
					<form action="{$shop2.uri}?mode=cart&action=up" id="shop2-cart" data-cart-amount="{$sum_amount}" autocomplete="off">
							...
							<div class="shop2-cart-table__btns">
								{if $shop2.my.gr_cart_calculate_left}
									<div class="shop2-cart-update{if $show_recalculate_button} show{/if}">
										<a href="#" class="{$shop2.my.cart_update_btn_class|default:'gr-btn gr-btn-lg gr-btn-3'} shop2-cart-update">{#SHOP2_RECALCULATE#}</a>
									</div>
								{/if}
								<div class="shop2-cart-table__cleanup">
									<a href="{$shop2.uri}?mode=cart&action=cleanup" class="{$shop2.my.cart_cleanup_btn|default:'gr_btn_i_l'}">
										<span>
											<ins>{#SHOP2_CLEAR_CART#}</ins>
											<i>
												<svg class="gr-svg-icon">
				...
				<div class="cart-page__right">
					{if $shop2.my.gr_cart_coupon_toggle || $shop2.my.gr_cart_coupon_remodal}
						<div class="coupon-additional">
							...
							<div class="{$shop2.my.coupon_additional_btn_class|default:'gr-btn gr-btn-3'} coupon-additional__btn"{if $shop2.my.gr_cart_coupon_remodal} data-remodal-target="coupon-remodal"{/if}>
						...
						<div class="shop-coupon">
							<div class="shop-coupon__inner">
								...
								<div class="shop-coupon__body">
									...
									<button class="{$shop2.my.coupon_btn_class|default:'gr-btn gr-btn-1'} coupon-btn"><span>{#SHOP2_APPLY#}</span></button>
								</div>
							</div>
					...
					<div class="cart-total">
								...
								<div class="cart-bonuses__container{if $cart.bonusParams.enabled && $cart.bonusParams.is_using && isset($user.user_id) && $cart.totals.sum_discount_bonus|price_convert>0} show_bonuses{/if}">
									...
									<div class="cart-bonuses__body">
										...
										<div class="cart-bonuses__right">
											<button type="button" class="{$shop2.my.bonus_apply_btn_class|default:'gr-btn gr-btn-1'} bonus-apply">{#SHOP2_APPLY#|l}</button>
											<button type="button" class="{$shop2.my.bonus_delete_btn_class|default:'gr-btn gr-btn-1'} bonus-delete">{#DELETE#|l}</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cart-total__btns{if !(($hide_auth_form || isset($user.user_id)) && !$order_in_one_page) && !(($shop2.my.gr_cart_auth_remodal && !$hide_auth_form && !isset($user.user_id)) && !$order_in_one_page)} no_btns{/if}">
							{if !$shop2.my.gr_cart_calculate_left}
								<div class="shop2-cart-update{if $show_recalculate_button} show{/if}">
									<a href="#" class="{$shop2.my.cart_update_btn_class|default:'gr-btn gr-btn-lg gr-btn-3'} shop2-cart-update"><span>{#SHOP2_RECALCULATE#}</span></a>
								</div>
							{/if}
							{if ($hide_auth_form || isset($user.user_id)) && !$order_in_one_page}
								<a href="{$shop2.uri}?mode=order" class="{$shop2.my.cart_total_order_checkout_class|default:'gr-btn gr-btn-lg gr-btn-2'} cart-total-order-checkout cart_total_order_checkout">
									<span>{#SHOP2_CHECKOUT#}</span></a>
							{/if}
							{if ($shop2.my.gr_cart_auth_remodal && !$hide_auth_form && !isset($user.user_id)) && !$order_in_one_page}
								<div class="{$shop2.my.cart_total_checkout_class|default:'gr-btn gr-btn-lg gr-btn-2'} cart-total-checkout cart_total_checkout" data-remodal-target="cart-auth-remodal">
					...
					{if !$order_in_one_page && !isset($user.user_id)}
						...
						{/if}
							<form method="post" action="{$user_settings.link}" class="form-registration">
								...
								<button class="{$shop2.my.form_registration_btn_class|default:'gr-btn gr-btn-lg gr-btn-1'} form-registration__btn form_registration_btn" type="submit">
							...
							<div class="cart-registration__btns">
								{if !$order_in_one_page}
									<div class="cart-registration__btn">
										<a href="{$shop2.uri}?mode=order" class="{$shop2.my.cart_registration_btn_class|default:'gr-btn gr-btn-lg gr-btn-1'} cart-registration-btn">
						...
						{if $order_in_one_page}
							<div class="shop2-cart-auth">
								...
								<form class="shop2-cart-auth__form js-shop2-cart-auth__form" method="post" action="{$user_settings.link}">
									...
									<button class="{$shop2.my.shop2_cart_auth__btn_class|default:'gr-btn gr-btn-1'} shop2-cart-auth__btn" type="submit">
										<span>{#SHOP2_LOG_IN_PLACE_ORDER#}</span>
									</button>
