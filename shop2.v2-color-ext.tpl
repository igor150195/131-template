		...
		{if $shop2.my.gr_filter_color_btn}
	        ...
	        {if $param.options|@count>$gr_max_count}
				...
				<div class="gr-filter-more">
		            <span class="{$shop2.my.gr_filter_more_btn_class|default:'gr-btn gr-btn-sm gr-btn-3'} gr-filter-more__btn" data-text="{$shop2.my.gr_filter_select_btn|default:'Показать еще'}" data-fields-total="{$colors_total}">
